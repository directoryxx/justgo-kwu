...
public class LoginActivity extends AppCompatActivity {
    ...
    private EditText edemail1,edpassword1;
    private ImageView imLogin2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edpassword1 = (EditText) findViewById(R.id.edpassword2);
        progressBar = (ProgressBar) findViewById(R.id.progressBar);
        imLogin2 = (ImageView) findViewById(R.id.imageView2);

        imLogin2.setOnClickListener(new View.OnClickListener() {
            @Override
